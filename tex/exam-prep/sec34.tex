...
\begin{tipbox}{关键词标签}
离子晶体 · 库仑势 · Born-Mayer排斥势 · 平衡间距 · 压缩做功 · 泰勒展开
\end{tipbox}
...
\[
  R_0 = \left(\frac{nA}{2q^2\ln 2}\right)^{\!\frac{1}{n-1}}, \qquad
  U(R_0) = -\frac{2Nq^2\ln 2}{R_0}\left(1-\frac{1}{n}\right), \qquad
  W = \frac{Nq^2(n-1)\ln 2}{R_0}\,\delta^2.
\]
本题是 sec33（马德隆常数）与 sec25（幂律势）的\textbf{综合应用}：库仑吸引提供长程结合，Born-Mayer 排斥提供短程支撑，两者竞争决定平衡位置。
\end{insightbox}
...
由 sec33 结论，一维交替链的马德隆常数 $M = 2\ln 2$。$N$ 对离子（共 $2N$ 个）的总势能为
\[
...
一维和三维的数学结构完全相同，差异仅在于马德隆常数的数值和几何因子。
