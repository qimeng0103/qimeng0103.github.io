...
\begin{tipbox}{关键词标签}
晶体结合能 · 幂律势 · 体积弹性模量 · 平衡条件 · 离解能 · 离子晶体
\end{tipbox}
...
\begin{enumerate}[nosep]
  ...
  \item 设平衡时两原子间距 $r_0 = 3\,\mathring{\mathrm{A}}$，每个原子的离解能为 $4\,\text{eV}$，$m=2$, $n=10$，计算 $\alpha$ 及 $\beta$ 值。
\end{enumerate}
\end{modelbox}
...
已知：$r_0 = 3\,\mathring{\mathrm{A}}$，每个原子的离解能 $|U_0|/N = 4\,\text{eV}$，$m=2$, $n=10$。
...
解得
\[
  \boxed{ \alpha = 90\,\mathrm{eV}\cdot\mathring{\mathrm{A}}^2 }.
\]
...
故
\[
  \boxed{ \beta \approx 1.18\times 10^5\,\mathrm{eV}\cdot\mathring{\mathrm{A}}^{10} }.
\]
...
\begin{itemize}[nosep]
  ...
  \item 本题 $m=2$：$[\alpha] = \mathrm{eV}\cdot\mathring{\mathrm{A}}^2$。正确。
  \item 本题 $n=10$：$[\beta] = \mathrm{eV}\cdot\mathring{\mathrm{A}}^{10}$。正确。
\end{itemize}
\end{tipbox}
...
由 $K = |U_0|mn/(9V_0)$，结合能 $|U_0|/N \sim \text{eV/atom}$，原子体积 $V_0/N \sim \mathring{\mathrm{A}}^3$，得
\[
  K \sim \frac{(\text{eV})(1)(10)}{9(\mathring{\mathrm{A}}^3)} \sim 10\,\text{eV/\mathring{\mathrm{A}}}^3 \sim 10^{11}\,\text{Pa} = 10^2\,\text{GPa}.
\]
