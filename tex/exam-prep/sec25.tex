...
\[
  K = \frac{|U_0|\, mn}{9V_0}, \qquad \alpha = 90\,\text{eV\cdot\AA}^2, \qquad \beta \approx 1.18\times 10^5\,\text{eV\cdot\AA}^{10}.
\]
本题的普适性极强：只要相互作用是幂律形式（吸引项 $-C/r^m$ + 排斥项 $+D/r^n$），体积模量与结合能的关系就被 $mn/9$ 这个纯数字锁定，与晶体结构细节无关。
\end{insightbox}
