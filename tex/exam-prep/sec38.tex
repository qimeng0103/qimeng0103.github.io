...
\begin{figure}[htbp]
  ...
  \caption{FCC 配位壳层示意图。\textbf{上排}：每个子图单独显示一个壳层（紫色线框为晶胞边界，黑球为中心原子）——红球为第 1 壳层（12 个，距离 $r$），蓝球为第 2 壳层（6 个，距离 $\sqrt{2}\,r$），绿球为第 3 壳层（24 个，距离 $\sqrt{3}\,r$）。\textbf{下排左}：三壳层合并视图；\textbf{下排中}：各壳层原子数柱状图；\textbf{下排右}：各壳层坐标规律（以 $a/2$ 为单位）。}
