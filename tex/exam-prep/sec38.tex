...
\begin{figure}[htbp]
  ...
  \caption{FCC 配位壳层示意图。\textbf{左图}：3D 视图，黑球为中心原子，红球为第 1 壳层（12 个，距离 $r$），蓝球为第 2 壳层（6 个，距离 $\sqrt{2}\,r$），绿球为第 3 壳层（24 个，距离 $\sqrt{3}\,r$）。\textbf{右图}：$xy$ 平面投影，紫色方框表示一个晶胞面（$a\times a$），虚线标注了各壳层到原点的距离。}
