...
\begin{modelbox}[平面转子在匀强电场中的微扰修正]
...
\begin{derivationbox}[未微扰系统的本征值与本征函数]
转动惯量 $I = mr^2$，哈密顿量为
\[
...
\begin{derivationbox}[微扰项的矩阵元与选择定则]
电场沿 $-x$ 方向，微扰势能：
\[
...
\begin{insightbox}[简并微扰中何时能直接套用非简并二级公式]
...
\begin{derivationbox}[第一激发态 $|m|=1$ 的二级修正]
