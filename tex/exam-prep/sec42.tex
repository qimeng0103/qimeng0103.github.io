...
\textbf{1. 为什么 $\langle K\rangle=\langle U\rangle$？}

对任何简谐振子（无论是一维、二维还是三维），动能正比于 $\sin^2(\omega t+\phi)$，势能正比于 $\cos^2(\omega t+\phi)$（或反之）。由于 $\langle\sin^2\rangle=\langle\cos^2\rangle=1/2$，两者的时间平均值必然相等。这一结论与维度、晶格结构、波矢 $q$ 的具体取值均无关，是简谐近似的普适结果。
