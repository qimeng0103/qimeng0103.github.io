...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{images/nacl_unit_cell.png}
\caption{NaCl 晶胞三维示意图。蓝色球为 Na$^+$（占据角和面心），绿色球为 Cl$^-$（占据棱中点和体心）。红色箭头标出最近邻距离 $r_0 = a/2$，紫色箭头标出晶胞边长 $a$。图中同时标注了分摊法计数时各位置的权重。}
