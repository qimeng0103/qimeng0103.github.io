...
在更低的频率处 $n$ 更大（$n\approx k_BT/\hbar\omega\gg1$），但这些低频模式的权重被 $\omega^2$ 抑制；而在高频端 $n$ 很小。加权平均后，有效声子数集中在 $x\sim1$ 附近（$n\sim O(1)$），整个积分 $\int_0^{\infty}x^2/(e^x-1)\,dx=2\zeta(3)$ 只是一个与温度无关的纯数值。因此温度依赖完全来自于前面的 $(k_BT/\hbar)^3$ 因子。
