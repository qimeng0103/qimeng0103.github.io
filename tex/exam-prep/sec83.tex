...
由波矢定义：
\begin{equation}
p_h=\hbar k_h=1.055\times10^{-34}\times(-3.98\times10^8)\approx-4.20\times10^{-26}\,\text{N\cdot s}.
\end{equation}

由有效质量和速度验证：
\begin{equation}
p_h=m_h^*v_h=1.52\times10^{-31}\times(-2.77\times10^5)\approx-4.20\times10^{-26}\,\text{N\cdot s}.
\end{equation}
两者一致。
\begin{equation}
\boxed{p_h\approx-4.20\times10^{-26}\,\text{N\cdot s}.}
\end{equation}
...
(4) 动量 $p_h$ & $-4.20\times10^{-26}\,\text{N\cdot s}$ & $p_h=\hbar k_h=m_h^*v_h$ \\
