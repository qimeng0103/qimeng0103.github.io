...
= -\frac{3Nk_{\!B}}{2}\frac{\hbar\omega_E}{k_{\!B}T} - 3Nk_{\!B}\ln\!\left(1-e^{-\hbar\omega_E/k_{\!B}T}\right).
\end{equation}

产生 $n$ 个空位后，每个空位周围有 $m$ 个原子振动频率变为 $\omega'$。共有 $3nm$ 个模式频率为 $\omega'$，其余 $3(N-nm)$ 个模式频率仍为 $\omega_E$。此时振动熵为
\begin{multline}
S = -\frac{3(N-nm)k_{\!B}}{2}\frac{\hbar\omega_E}{k_{\!B}T} - \frac{3nmk_{\!B}}{2}\frac{\hbar\omega'}{k_{\!B}T} \\
- 3(N-nm)k_{\!B}\ln\!\left(1-e^{-\hbar\omega_E/k_{\!B}T}\right)
- 3nmk_{\!B}\ln\!\left(1-e^{-\hbar\omega'/k_{\!B}T}\right).
\end{multline}

振动熵变 $\Delta S_{\mathrm{vib}} = S - S_0$，化简得
\begin{multline}
\Delta S_{\mathrm{vib}} = -\frac{3nm\hbar(\omega'-\omega_E)}{2T} \\
+ 3nmk_{\!B}\ln\!\left[\frac{1-e^{-\hbar\omega_E/k_{\!B}T}}{1-e^{-\hbar\omega'/k_{\!B}T}}\right].
