...
BCC 的倒格子为 FCC，第一布里渊区为 \textbf{截角八面体}（8 个正六边形面 + 6 个正方形面）。到最近边界（六边形面，垂直于 $\langle111\rangle$ 方向）的距离为
\begin{equation}
k_{\text{边界}}=\frac{|\bm{G}_{111}|}{2}=\frac{1}{2}\cdot\frac{2\pi\sqrt{3}}{a}=\frac{\pi\sqrt{3}}{a}\approx\frac{5.44}{a}.
\end{equation}
由于 $k_F\approx3.90/a < k_{\text{边界}}\approx5.44/a$，Na 的费米面 \textbf{完全位于第一布里渊区内部}，未接触边界。这与经典教材中 Na 费米面近似为球面的结论一致。
