...
**叙事体写作（重要！）：**
- ❌ **禁止习题解答格式**：不允许使用 "Exercise", "Problem", "Solution", "Part (a)-(d)" 等标记。即使是基于教材习题的内容，也必须转化为流畅的客观论述
- ❌ **禁止自我指涉**：不出现 "This note was written...", "The goal is..." 等元评论
- ✅ **叙事连贯性**：内容应像一篇独立的学术散文，从动机到分析再到综合，自然过渡
- ✅ **数学作为论述的一部分**：公式和推导嵌入叙述流中，而非孤立地罗列在"解答"标题下
